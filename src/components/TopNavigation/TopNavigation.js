    ...
    render() {
        return (
            <Fragment>
                ...
                <Navbar variant={this.state.navVariant} href="#deets" className={this.state.navBarBack} fixed="top" collapseOnSelect expand="lg">
                    <Navbar.Brand><NavLink className={this.state.navBarTitle} to="/"><img src={this.state.navBarLogo}/> Redwan Hossain</NavLink></Navbar.Brand>
